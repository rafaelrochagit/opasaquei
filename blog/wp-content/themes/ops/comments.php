...
<div id="comments">
    ...
    <div id="respond">
            ...
            <fieldset>
                ...
                <input type="text" placeholder="Nome" name="author" class="form-control" id="author" value="<?php echo $comment_author; ?>" />
 
                <input type="text" placeholder="E-mail" name="email" class="form-control" id="email" value="<?php echo $comment_author_email; ?>" />
               ...
               <!--  <label for="url">Website:</label>
                ...
                <textarea name="comment" placeholder="Mensagem" class="form-control" id="comment" rows="" cols=""></textarea>
 
                <input type="submit" class="commentsubmit btn btn-default" value="Enviar Comentário" />
